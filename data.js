...
exports.spinyRatPath = exports.hexArray = exports.cols = exports.rows = exports.first_c = exports.first_r = void 0;
...
exports.cols = 10;
// Array of hexes
exports.hexArray = new Array(exports.cols);
for (var i = 0; i < exports.cols; i++) {
    exports.hexArray[i] = new Array(exports.rows);
    for (var j = 0; j < exports.rows; j++) {
        exports.hexArray[i][j] = new model_1.Hex(i, j, exports.first_c, exports.first_r);
    }
}
var getHex = function (view_col, view_row) {
    return exports.hexArray[view_col - exports.first_c][view_row - exports.first_r];
};
...
exports.spinyRatPath = [];
var add = function (hex1, offset1, hex2, offset2) {
    var segment = new model_1.PathSegment(hex1, offset1, hex2, offset2);
    exports.spinyRatPath.push(segment);
    return segment;
};
